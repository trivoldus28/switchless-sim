...
%A general-purpose dedicated core may also be more desirable for Software Defined Networking (SDN)[CITE], where the routing protocol can be configured based on the application and network conditions [IS THIS SDN??]. -- Wild guess
