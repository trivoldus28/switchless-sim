...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '--std=gnu++0x', '-g', '-I../examples/HadoopSim', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['--std=gnu++0x', '-g', '-I../examples/HadoopSim']
...
EXAMPLE_DIRECTORIES = ['routing', 'socket', 'naming', 'wireless', 'energy', 'stats', 'HadoopSim', 'udp-client-server', 'ipv6', 'error-model', 'tutorial', 'udp', 'realtime', 'tcp', 'matrix-topology']
...
NS3_EXECUTABLE_PATH = ['/home/trin/programming/switchless-sim/ns-allinone-3.18.1/ns-3.18.1/build/src/emu', '/home/trin/programming/switchless-sim/ns-allinone-3.18.1/ns-3.18.1/build/src/fd-net-device', '/home/trin/programming/switchless-sim/ns-allinone-3.18.1/ns-3.18.1/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/i686-linux-gnu/4.8', '/home/trin/programming/switchless-sim/ns-allinone-3.18.1/ns-3.18.1/build']
...
cfg_files = ['/home/trin/programming/switchless-sim/ns-allinone-3.18.1/ns-3.18.1/build/ns3/config-store-config.h', '/home/trin/programming/switchless-sim/ns-allinone-3.18.1/ns-3.18.1/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
