...
#ifndef POINT_TO_POINT_MESH_DIMORDERED_HELPER_H
#define POINT_TO_POINT_MESH_DIMORDERED_HELPER_H
 ...
 * with p2p links
 */
class PointToPointMeshDimorderedHelper : public PointToPointTopoHelper 
{
public: 
  /**
   * Create a PointToPointMeshDimorderedHelper in order to easily create
   ...
   *                     in the grid
   */
  PointToPointMeshDimorderedHelper (uint32_t nRows, 
                          uint32_t nCols, bool isTorus,
                          PointToPointHelper pointToPoint);

  ~PointToPointMeshDimorderedHelper ();
...
#endif /* POINT_TO_POINT_MESH_DIMORDERED_HELPER_H */
