...
#ifndef POINT_TO_POINT_TORUS_HELPER_H
#define POINT_TO_POINT_TORUS_HELPER_H
 ...
 * with p2p links
 */
class PointToPoint2DTorusHelper 
{
public: 
  /**
   * Create a PointToPoint2DTorusHelper in order to easily create
   ...
   *                     in the grid
   */
  PointToPoint2DTorusHelper (uint32_t nRows, 
                          uint32_t nCols, 
                          PointToPointHelper pointToPoint);

  ~PointToPoint2DTorusHelper ();
