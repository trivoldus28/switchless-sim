...
#ifndef DO_TCP_TX_BUFFER_H
#define DO_TCP_TX_BUFFER_H
 ...
 *        the sending buffer.
 */
class DoTcpTxBuffer : public Object
{
public:
  static TypeId GetTypeId (void);
  DoTcpTxBuffer (uint32_t n = 0);
  virtual ~DoTcpTxBuffer (void);
