...
#ifndef DIM_ORDERED_RAW_CLIENT_H
#define DIM_ORDERED_RAW_CLIENT_H
...
class DimensionOrderedRawClient : public Application
{
public:
  // Constructor/Destructor
  DimensionOrderedRawClient ();
  virtual ~DimensionOrderedRawClient ();
...
#endif /* DIM_ORDERED_RAW_CLIENT_H */
