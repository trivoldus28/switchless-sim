...
#include "dim-ordered-udp-example.h"
...
main (int argc, char *argv[])
{
    ...
    //LogComponentEnable ("DoUdpL4Protocol", LOG_LEVEL_ALL);
    ...
    Ptr<DimensionOrderedUdpServer> server1 = CreateObject<DimensionOrderedUdpServer> ();
    server1->Setup ();
    // Install on node 2
    ...
    Ptr<DimensionOrderedUdpClient> client2 = CreateObject<DimensionOrderedUdpClient> ();
    // Send to node 6
    ...
    Ptr<DimensionOrderedUdpServer> server2 = CreateObject<DimensionOrderedUdpServer> ();
    server2->Setup ();
    // Install on node 6
