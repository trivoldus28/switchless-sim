...
#ifndef DIM_ORDERED_TCP_SERVER_H
#define DIM_ORDERED_TCP_SERVER_H
...
class DimensionOrderedTcpServer : public Application
{
public:
  // Constructor/Destructor
  DimensionOrderedTcpServer ();
  virtual ~DimensionOrderedTcpServer ();
...
#endif /* DIM_ORDERED_TCP_SERVER_H */
