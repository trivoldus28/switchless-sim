...
#ifndef DIM_ORDERED_UDP_SERVER_H
#define DIM_ORDERED_UDP_SERVER_H
...
class DimensionOrderedUdpServer : public Application
{
public:
  // Constructor/Destructor
  DimensionOrderedUdpServer ();
  virtual ~DimensionOrderedUdpServer ();
...
#endif /* DIM_ORDERED_UDP_SERVER_H */
