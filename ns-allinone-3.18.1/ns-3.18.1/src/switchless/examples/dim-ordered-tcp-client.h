...
#ifndef DIM_ORDERED_TCP_CLIENT_H
#define DIM_ORDERED_TCP_CLIENT_H
...
class DimensionOrderedTcpClient : public Application
{
public:
  // Constructor/Destructor
  DimensionOrderedTcpClient ();
  virtual ~DimensionOrderedTcpClient ();
...
#endif /* DIM_ORDERED_TCP_CLIENT_H */
